...
pub mod tests {
    ...
    fn read_offset_u8() {
        ...
        assert_eq!(s.read_offset::<u8>(&mem, 0).unwrap(), 10);
        assert_eq!(s.read_offset::<u8>(&mem, 1).unwrap(), 20);
        assert_eq!(s.read_offset::<u8>(&mem, 2).unwrap(), 30);
        assert_eq!(s.read_offset::<u8>(&mem, 3).unwrap(), 40);
    }
    ...
    fn read_offset_u16() {
        ...
        assert_eq!(s.read_offset::<u16>(&mem, 0).unwrap(), 10);
        assert_eq!(s.read_offset::<u16>(&mem, 1).unwrap(), 20);
        assert_eq!(s.read_offset::<u16>(&mem, 2).unwrap(), 30);
        assert_eq!(s.read_offset::<u16>(&mem, 3).unwrap(), 40);
    }
    ...
    fn read_offset_u32() {
        ...
        assert_eq!(s.read_offset::<u32>(&mem, 0).unwrap(), 10);
        assert_eq!(s.read_offset::<u32>(&mem, 1).unwrap(), 20);
        assert_eq!(s.read_offset::<u32>(&mem, 2).unwrap(), 30);
        assert_eq!(s.read_offset::<u32>(&mem, 3).unwrap(), 40);
    }
    ...
    fn read_offset_u64() {
        ...
        assert_eq!(s.read_offset::<u64>(&mem, 0).unwrap(), 10);
        assert_eq!(s.read_offset::<u64>(&mem, 1).unwrap(), 20);
